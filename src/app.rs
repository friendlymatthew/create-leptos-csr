...
fn HomePage() -> impl IntoView {
    ...
    const REPO_LINK: &'static str = "https://github.com/friendlymatthew/leptos-csr-starter-kit";


    view! {
        <main class="dark:bg-[#121212] bg-white dark:text-white h-screen w-full py-20 space-y-8 font-robotomono">
            <div class="text-center space-y-2">
                <p class="text-3xl">Welcome to Leptos!</p>
            ...
            >
                <div>
                    ...
                    <p>
                        ...
                        <a
                            class="hover:no-underline underline"
                            href=format!("{}/issues/new", REPO_LINK)
                            target="_blank"
                            rel="noreferrer"
                        >
                            a issue
